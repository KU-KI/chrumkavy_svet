    ...
    <div class="container">
        <div class="starter-template">
            ...
            <form id="formularavatar" method="post" action="settings.php">
                ...
                <input type="image" name="avatar" value="3" alt="3" src="assets/img/avatar/3.png" style="width:80px;height:80px;" />
                <input type="image" name="avatar" value="4" alt="4" src="assets/img/avatar/4.png" style="width:80px;height:80px;" />
                <input type="image" name="avatar" value="5" alt="5" src="assets/img/avatar/5.png" style="width:80px;height:80px;" />
                <input type="image" name="avatar" value="6" alt="6" src="assets/img/avatar/6.png" style="width:80px;height:80px;" />
            </form>
    </div>
    </div>
